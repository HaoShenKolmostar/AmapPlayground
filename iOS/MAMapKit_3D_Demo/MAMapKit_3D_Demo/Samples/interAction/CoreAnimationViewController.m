...
- (CAKeyframeAnimation *)centerMapPointAnimation
{
...
#define RATIO 100.f
    ...
    CAKeyframeAnimation *centerAnimation = [[CAKeyframeAnimation alloc] init];
...
- (CAKeyframeAnimation *)cameraDegreeAnimation
{
    ...
    cameraDegreeAnimation.values = @[@(0.f), @(45.f)];
...
-(CAKeyframeAnimation *)rotationDegreeKey
{
    ...
    rotationDegreeAnimation.values = @[@(0.f), @(180.f)];
...
{
    [self.mapView addAnimationWith:[self centerMapPointAnimation]
